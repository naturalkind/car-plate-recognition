...
def convolutional_layers():
    ...
    x = Activation('relu')(x)
    x = Conv2D(128, (3, 3), padding='valid', name='conv6', kernel_initializer='he_normal')(x)
    x = Activation('relu')(x)
    x = Conv2D(128, (3, 3), padding='valid', name='conv7', kernel_initializer='he_normal')(x)
    x = Activation('relu')(x)
    x = Conv2D(128, (2, 2), padding='valid', name='conv8', kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
    x = Activation('relu')(x)    
    print (x.shape)
